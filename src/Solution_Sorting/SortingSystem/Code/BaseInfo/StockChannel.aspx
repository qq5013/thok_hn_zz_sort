<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockChannel.aspx.cs" Inherits="Code_BaseInfo_Channel" %>
                        ...
                        <table class="OperationBar">   
                           ...
                           <table width="100%">
                                <tr>
                                    <td class="tdTitle">
                                        烟道代码:</td>
                                    <td ><asp:TextBox ID="txtChannelCode" runat="server" MaxLength="12" CssClass="Textbox"></asp:TextBox></td>
                                    <td style="height: 0px; width: 72px;" > 
                                    </td>
                                </tr>
                                <tr class="tdTitle">
                                    <td class="tdTitle">卷烟代码:</td>
                                    <td ><asp:TextBox ID="txtCigaretteCode" runat="server" MaxLength="10" CssClass="TextBox"></asp:TextBox></td>
                                ...
                                <tr >
                                    ...
                                    <td><asp:TextBox ID="txtCigaretteName" runat="server" MaxLength="50" CssClass="TextBox"></asp:TextBox></td>
                                ...
                                <tr >
                                    ...
                                    <td><asp:TextBox ID="txtLedNo" runat="server" MaxLength="4" CssClass="TextBox"></asp:TextBox></td>
                                    <td height="20" style="width: 72px" >
                                        </td>
                                </tr>
                                    <tr>
