<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChannelSupplyQuery.aspx.cs" Inherits="Code_Query_ChannelSupplyQuery" %>
                        ...
                        <asp:Panel id="pnlGrid" runat="server" Width="100%" Height="460px">
                            <asp:GridView id="gvMain" runat="server" Width="100%" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LQUANTITY" HeaderText="条数">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <HeaderStyle Width="50px" />
                                    </asp:BoundField>
                                </Columns>
