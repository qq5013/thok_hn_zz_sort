...
public partial class Code_Query_AbnormalSupplyQuery: BasePage
{
    ...
    private void BindData()
    {
        ...
        pager.RecordCount = acDal.GetLineCount(filter);
        DataTable table = acDal.GetLineAll(pageIndex, PagingSize, filter);
