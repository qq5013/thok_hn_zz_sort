...
public partial class Code_Query_HandleSupplyDetail : BasePage
{
    ...
    private void BindData()
    {
        ...
        HandleCigaretteDal hcDal = new HandleCigaretteDal();
        string filter = null;
        if (ViewState["Filter"] != null)
            filter = ViewState["Filter"].ToString();
        pager.RecordCount = hcDal.GetLineDetailCount(filter);
        DataTable table = hcDal.GetLineAllDetail(pageIndex, PagingSize, filter);
