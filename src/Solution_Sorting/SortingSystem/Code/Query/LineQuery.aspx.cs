...
public partial class Code_Query_LineQuery : BasePage
{
    ...
    private void BindData()
    {
        ...
        LineScheduleDal lsDal = new LineScheduleDal();
        string filter = null;
        if (ViewState["Filter"] != null)
            filter = ViewState["Filter"].ToString();
        pager.RecordCount = lsDal.GetCount(filter);
        DataTable table = lsDal.GetAll(pageIndex, PagingSize, filter);
