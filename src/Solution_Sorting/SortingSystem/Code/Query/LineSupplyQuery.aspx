<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LineSupplyQuery.aspx.cs" Inherits="Code_Query_LineSupplyQuery" %>
                    ...
                    <asp:Panel id="pnlList" runat="server" Width="100%" Height="401px">
                        ...
                        <asp:Panel id="pnlGrid" runat="server" Width="100%" Height="460px">
                            <asp:GridView id="gvMain" runat="server" Width="100%" AutoGenerateColumns="False">
                                <Columns>
                                    <asp:BoundField DataField="ORDERDATE" DataFormatString="{0:yyyy-MM-dd}" HeaderText="分拣日期" HtmlEncode="False" >
                                    ...
                                    <asp:BoundField DataField="JQUANTITY" HeaderText="整件数">
                                        <ItemStyle HorizontalAlign="Right" />
                                        <HeaderStyle Width="50px" />
                                    </asp:BoundField>
