...
public partial class Code_Query_ChannelSupplyQuery : BasePage
{
    ...
    private void BindData()
    {
        ...
        ChannelScheduleDal ccDal = new ChannelScheduleDal();
        string filter = null;
        if (ViewState["Filter"] != null)
            filter = ViewState["Filter"].ToString();
        pager.RecordCount = ccDal.GetCount(filter);
        DataTable table = ccDal.GetAll(pageIndex, PagingSize, filter);
