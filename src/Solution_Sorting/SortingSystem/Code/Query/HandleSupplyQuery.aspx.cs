...
public partial class Code_Query_HandleSupplyQuery : BasePage
{
    ...
    private void BindData()
    {
        ...
        pager.RecordCount = hcDal.GetLineCount(filter);
        DataTable table = hcDal.GetLineAll(pageIndex, PagingSize, filter);
