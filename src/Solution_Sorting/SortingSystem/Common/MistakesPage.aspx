    ...
    <table width="515" height="371" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
      ...
      <tr>
        ...
        <td valign="top" background="../images/mistakes_bg1.jpg" style="height: 324px; width: 395px;"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="right" valign="top" style="vertical-align: middle; text-align: right; height: 35px;"><span class="STYLE1">模块：</span></td>
            <td style="vertical-align: middle; text-align: left; height: 35px;">
                <asp:Label ID="labModuleName" runat="server"></asp:Label></td>
            </tr>
          <tr>
            <td align="right" valign="top" style="vertical-align: middle; text-align: right; height: 35px;"><span class="STYLE1">方法：</span></td>
            <td style="vertical-align: middle; text-align: left; height: 35px;">
                <asp:Label ID="labFunctionName" runat="server"></asp:Label></td>
            </tr>
          <tr>
            <td align="right" valign="top" style="vertical-align: middle; text-align: right; height: 35px;"><span class="STYLE1">类型：</span></td>
            <td style="vertical-align: middle; text-align: left; height: 35px;">
                <asp:Label ID="labExceptionalType" runat="server"></asp:Label></td>
            </tr>
          <tr>
            <td height="30" align="right" valign="top" style="vertical-align: middle; text-align: right;"><span class="STYLE1">内容：</span></td>
          ...
          <tr>
            <td style="height: 75px; width: 90px;">&nbsp;</td>
            </tr>
        </table></td>
        <td rowspan="3" valign="bottom" style="width: 114px"><img src="../images/mistakes_bg2.jpg" alt="" width="100" height="104" border="0" usemap="#Map" />
          <map name="Map" id="Map">
            <area shape="rect" coords="31,65,71,82" href="#" onclick="javascript:history.back();"/>
          </map></td>
      </tr>
      <tr>
