...
namespace THOK.AS.OTS.Dao
{
    public class OrderDao: BaseDao
    {
        ...
        public DataTable FindOrderMaster()
        {
            ...
            sql = "SELECT ROW_NUMBER() OVER(ORDER BY MIN(SORTNO)) AS CUSTOMERNO,MIN(SORTNO) AS SORTNO ,ORDERDATE,ORDERID,ROUTECODE,ROUTENAME,CUSTOMERCODE,CUSTOMERNAME,ADDRESS,ORDERNO,SUM(QUANTITY) AS QUANTITY, ABNORMITY_QUANTITY," +
